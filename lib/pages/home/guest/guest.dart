    ...
    return Scaffold(
      appBar: AppBar(
        ...
        actions: [
         ...
         ElevatedButton(style: ElevatedButton.styleFrom(backgroundColor: KAppColors.kPrimary),onPressed: () => Get.to(LoginOrSignupScreen()), child: Row(children: [
          Text("Log in",style: TextStyle(color: Colors.white,fontFamily: "Popins"),),
          SizedBox(width: 10,),

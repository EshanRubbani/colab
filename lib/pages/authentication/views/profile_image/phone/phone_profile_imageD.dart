...
class PhoneProfileImageD extends StatefulWidget {
   final String phoneNumber;
  const PhoneProfileImageD({required this.phoneNumber,super.key});

  @override
  _PhoneProfileImageDState createState() => _PhoneProfileImageDState();
}

class _PhoneProfileImageDState extends State<PhoneProfileImageD> {
  ...
  Future<void> _uploadImage() async {
    ...
    try {
      final ref = _storage.ref().child('users/${widget.phoneNumber}.jpg');
      ...
      Get.offAll(() => const PhoneLogin()); // Navigate to LoginScreen
    } catch (e) {
